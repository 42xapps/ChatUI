...
public struct ChatTheme {
    ...
    public struct Colors {
        ...
        public init(
            mainBG: Color = ChatTheme.Palette.background,
            mainTint: Color = ChatTheme.Palette.ink,
            mainText: Color = ChatTheme.Palette.label,
            mainCaptionText: Color = ChatTheme.Palette.secondaryLabel,
            messageMyBG: Color = ChatTheme.Palette.outgoingBubble,
            messageReadStatus: Color = ChatTheme.Palette.success,
            messageMyText: Color = Color.white,
            messageMyTimeText: Color = Color.white.opacity(0.65),
            messageFriendBG: Color = ChatTheme.Palette.incomingBubble,
            messageFriendText: Color = ChatTheme.Palette.label,
            messageFriendTimeText: Color = ChatTheme.Palette.secondaryLabel,
            messageSystemBG: Color = ChatTheme.Palette.systemBubble,
            messageSystemText: Color = ChatTheme.Palette.secondaryLabel,
            messageSystemTimeText: Color = ChatTheme.Palette.secondaryLabel,
            inputBG: Color = ChatTheme.Palette.field,
            inputText: Color = ChatTheme.Palette.ink,
            inputPlaceholderText: Color = ChatTheme.Palette.placeholderLabel,
            inputIcon: Color = ChatTheme.Palette.ink,
            inputSignatureBG: Color = ChatTheme.Palette.signatureField,
            inputSignatureText: Color = ChatTheme.Palette.label,
            inputSignaturePlaceholderText: Color = ChatTheme.Palette.label.opacity(0.7),
            menuBG: Color = ChatTheme.Palette.menuBackground,
            menuText: Color = Color.white,
            menuTextDelete: Color = ChatTheme.Palette.error,
            statusError: Color = ChatTheme.Palette.error,
            statusGray: Color = ChatTheme.Palette.secondaryLabel,
            sendButtonBackground: Color = ChatTheme.Palette.ink,
            recordDot: Color = ChatTheme.Palette.error,
            recordButtonBackground: Color = ChatTheme.Palette.outgoingBubble
        ) {
            self.mainBG = mainBG
