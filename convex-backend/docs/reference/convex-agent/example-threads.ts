// Source: https://github.com/get-convex/agent/blob/main/example/convex/threads.ts
// Pulled 2026-08-22. Canonical example of `authorizeThreadAccess` — the auth
// pattern this app's own agent-backed functions should mirror (adapted to use
// this app's own conversationMembers-based membership check instead of a bare
// userId match, per model/conversations.ts's requireMembership).
